#!/usr/bin/env python3
"""
Fixed Simli plugin - copy of original with rate-limited logging fix
"""
...
class SimliAvatar:
    ...
    async def _process_audio_frames(self):
        """Simple audio frame processing for real-time playback with rate-limited logging"""
        ...
        while self.run and not self._stopping:
            try:
                ...
                if frame is None:
                    ...
                    elif self._none_frame_count % 10000 == 0:  # Log summary every 10000 frames instead of 1000
